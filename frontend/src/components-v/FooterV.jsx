...
function Footer() {
        return (<Box paddingLeft={"30px"}>
                <Box marginBottom={"80px"} marginTop={"60px"}>
                        <Flex className="footerBottomSection" wrap={'wrap'} >
                                <Box   >
                ...
                <Flex justifyContent={"space-between"} marginTop={"50px"} paddingRight={"30px"} wrap={'wrap'} >
                        <Box >
                                <Flex gap={"1rem"}>
                ...
                {/* 2nd Box */}
                <Flex gap={"1rem"} marginBottom={"30px"} marginTop={"30px"} wrap={'wrap'}>
                        <Box>About Us</Box>
                        <Box>|</Box>
                        <Box>Help Center</Box>
                        <Box>|</Box>
